{
    ...
    'category': 'Connector',
    'depends': [
        'base', 'contacts', 'sale', 'crm', 'stock', 'sale_management', 'account', 'purchase','phone_calls_technians'
    ],
    'data': [
        ...
        'views/recruitment_wt.xml',
        'views/project_wt.xml',
        'views/phone_calls_wt.xml',
        'wizard/wizard.xml',
    ], 
    'demo': [],
    'qweb': [],
