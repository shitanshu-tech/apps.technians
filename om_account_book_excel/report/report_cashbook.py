...
class ReportCashBookExcel(models.Model):
    _name = "report.om_account_book_excel.report_cashbook_excel"
    _inherit = 'report.report_xlsx.abstract'
    _description = 'Cash Book Excel'

    def generate_xlsx_report(self, workbook, data, obj):
        report_obj = self.env['report.om_account_daily_reports.report_cashbook']
        ...
        sheet.merge_range('A1:I1', "Account Cash Book", format1)
