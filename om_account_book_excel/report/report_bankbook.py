...
class ReportBankBookExcel(models.Model):
    _name = "report.om_account_book_excel.report_bankbook_excel"
    _inherit = 'report.report_xlsx.abstract'
    _description = 'Bank Book Excel'

    def generate_xlsx_report(self, workbook, data, obj):
        report_obj = self.env['report.om_account_daily_reports.report_bankbook']
        ...
        sheet.merge_range('A1:I1', "Account Bank Book", format1)
