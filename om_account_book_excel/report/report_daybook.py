...
class ReportDayBookExcel(models.Model):
    _name = "report.om_account_book_excel.report_daybook_excel"
    _inherit = 'report.report_xlsx.abstract'
    _description = 'Day Book Excel'
    ...
    def generate_xlsx_report(self, workbook, data, obj):
        ...
        format3 = workbook.add_format({'font_size': 12, 'align': 'right', 'right': True, 'left': True,
                                       'bottom': True, 'top': True, 'bold': True, 'bg_color': '#bfbfbf'})
        format4_date = workbook.add_format({'font_size': 10, 'align': 'left', 'bold': True, 'right': True, 'left': True,
        ...
        sheet.merge_range('A1:I1', "Account Day Book", format1)
        ...
        for account in results['Accounts']:
            sheet.merge_range(row, col, row, col + 5, account['date'], format4_date)
            ...
            for line in account['move_lines']:
                ...
                sheet.write(row, col + 2, line['lpartner_id'], format6)
